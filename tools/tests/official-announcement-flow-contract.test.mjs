...
test('hosted announcement manifest publishes the v3.0.0 release notice under 5 KiB', () => {
  ...
  assert.match(manifest.announcement.contentZh, /Agent 制卡/);
  assert.match(manifest.announcement.contentZh, /Agent 改卡/);
  ...
  assert.match(manifest.announcement.contentZh, /界面细节/);
  assert.match(manifest.announcement.contentEn, /Agent Card Creation/);
  assert.match(manifest.announcement.contentEn, /Agent Edit Cards/);
  assert.match(manifest.announcement.contentEn, /interface polish/);
